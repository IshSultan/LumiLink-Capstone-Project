...
REM
REM Generated by Vivado on Fri Nov 14 14:38:32 -0500 2025
...
echo "xvlog --incr --relax -prj tb_sd_reader_vlog.prj"
call xvlog  --incr --relax -prj tb_sd_reader_vlog.prj -log xvlog.log
